...
// Include all other functions from the original file (they remain the same)
// Copy the rest of the functions from the original sample-data-generator.php
// This is just the fixed version of the problematic function